...
class Check(object):
    ...
    def compQuadOffsets(self,quad,offsets):
        ...
        return
    def fontOutline(self,gl,fontfile="DevanagariSangamMN.ttf"):
        ...
        for contour in gl1.contours:
           ...
           for point in contour:
               ...
               if point[1] == 1: # on-curve
                   ...
                   if prevzero:
                       missing_point = (np.array(point[0]) + np.array(prevpoint[0]))/2
                   ...
                   prevzero = True
        return edges
    def printEdges(self,edges,offset=0,numbering=True):
        fig = plt.figure()
        ...
        #print len(codes)
        path = Path(verts,codes)
        patch = patches.PathPatch(path,facecolor='none',ec='red',lw=2)
